;(function() {
  ...
  var filePath = (function() {
    ...
    result = (result.length > min && !/test(?:\.js)?$/.test(last)) ? last : './lodash-testbuild.js';
  ...
  var mapCaches = (function() {
    var MapCache = (lodashStable.memoize).Cache;
    var result = {
  ...
  lodashStable.each(['findKey', 'findLast', 'findLastIndex', 'findLastKey'], function(methodName) {
  ...
  _.each(['findLast', 'findLastIndex'], function(methodName) {
    var func = _[methodName];
  ...
  _.each(['findKey', 'findLast', 'findLastKey'], function(methodName) {
    var func = _[methodName];
  ...
  lodashStable.each(['indexOf'], function(methodName) {
  ...
  lodashStable.each(['flow', 'flowRight'], function(methodName) {
    ...
    QUnit.test('`_.' + methodName + '` should support shortcut fusion', function(assert) {
      ...
      lodashStable.times(2, function(index) {
        var filter1 = _.filter,
            filter2 = lodashStable.curry(lodashStable.rearg(lodashStable.ary(_.filter, 2), 1, 0), 2),
            filter3 = (_.filter = index ? filter2 : filter1, filter2(predicate));

        var map1 = _.map,
            map2 = lodashStable.curry(lodashStable.rearg(lodashStable.ary(_.map, 2), 1, 0), 2),
            map3 = (_.map = index ? map2 : map1, map2(iteratee));

        var take1 = _.take,
            take2 = lodashStable.curry(lodashStable.rearg(lodashStable.ary(_.take, 2), 1, 0), 2),
    ...
    QUnit.test('`_.' + methodName + '` should work with curried functions with placeholders', function(assert) {
      ...
      var curried = lodashStable.curry(lodashStable.ary(_.map, 2), 2),
  ...
  lodashStable.each(['defaults', 'defaultsDeep', 'merge'], function(methodName) {
    var func = _[methodName],
  ...
  lodashStable.each(['merge'], function(methodName) {
    var func = _[methodName];
  ...
  lodashStable.each(['defaults', 'defaultsDeep', 'merge', 'mergeWith'], function(methodName) {
    var func = _[methodName];
  ...
  lodashStable.each(['mergeWith'], function(methodName) {
    var func = _[methodName],
  ...
  lodashStable.each(['forEach', 'forEachRight', 'forOwn', 'forOwnRight', 'transform'], function(methodName) {
    var func = _[methodName];
  ...
  (function() {
    ...
    QUnit.test('should ensure `customizer` is a function', function(assert) {
      ...
      var array = [1, 2, 3],
          eq = lodashStable.partial(_.isEqualWith, array),
  ...
  (function() {
    ...
    QUnit.test('should ensure `customizer` is a function', function(assert) {
      ...
      var object = { 'a': 1 },
          matches = lodashStable.partial(_.isMatchWith, object),
  ...
  QUnit.module('orderBy methods');

  lodashStable.each(['orderBy'], function(methodName) {
    var func = _[methodName];
  ...
  lodashStable.each(['toArray'], function(methodName) {
    var array = [1, 2, 3],
        func = _[methodName];
  ...
  (function() {
    ...
    QUnit.test('should output values from the first possible array', function(assert) {
      ...
      var actual = _.unionBy([{ 'x': 1, 'y': 1 }], [{ 'x': 1, 'y': 2 }], function(value) {return value.x});
  ...
  lodashStable.each(['uniq', 'uniqBy', 'uniqWith', 'sortedUniq', 'sortedUniqBy'], function(methodName) {
    ...
    if (isSorted) {
      objects = lodashStable.sortBy(objects, 'a');
    }
    else {
  ...
  (function() {
    ...
    var rejectFalsey = [].concat(checkFuncs);
